...
public class TestRatingService {
    ...
    public void setupServer() {
        server = new Server();
        server.startServer("src/test/java/net/thumbtack/school/server/data/ratingTest.json");
    }
    ...
    public void test_addRating() throws Exception {
        ...
        server.stopServer("src/test/java/net/thumbtack/school/server/data/saveRatingTest.json");
    }
