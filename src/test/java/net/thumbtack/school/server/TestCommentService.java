...
public class TestCommentService {
    ...
    public void setupServer() {
        server = new Server();
        server.startServer("src/test/java/net/thumbtack/school/server/data/commentTest.json");
    }
    ...
    public void test_addComment_addReplyComment() throws Exception {
        ...
        Assert.assertEquals("\"{}\"", server.addComment(requestLoginJsonString));
        server.stopServer("src/test/java/net/thumbtack/school/server/data/saveCommentTest.json");
    }
