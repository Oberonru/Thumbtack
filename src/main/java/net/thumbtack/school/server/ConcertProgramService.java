...
import net.thumbtack.school.server.request.ConcertProgramDtoRequest;
import net.thumbtack.school.server.response.SongForConcertModel;
...
public class ConcertProgramService {
    ...
    public List<SongForConcertModel> getConcertProgram(ConcertProgramDtoRequest request) throws Exception {
        ...
        List<SongForConcertModel> concertProgram = new ArrayList<>();
    ...
    private List<SongForConcertModel> composeConcert(List<SongForConcertModel> concertSongList, int duration) {
        List<SongForConcertModel> result = new ArrayList<>();
        int concertTime = 0;
